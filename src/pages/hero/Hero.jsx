...
const Hero = () => {
    return (
        <div className='w-full md:h-[calc(100vh-8ch)] bg-gradient-to-br from-violet-100 to-violet-50 lg:px-28 md:px-16 sm:px-7 px-4 mt-[8ch] flex items-center justify-center'>
            <div className="w-full h-auto bg-violet-950 rounded-md p-10 flex items-center justify-between">
                ...
                <div className='w-1/2 flex items-center justify-end relative'>
                    ...
                    {/*  */}
                    <div className="absolute bottom-12 left-[50%] translate-x-[-50%] whitespace-nowrap w-fit h-auto rounded-md px-3 py-1 bg-violet-950/70 text-base text-neutral-100 font-medium">
